...
const geminiResponse = await axios.post("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyCyC2NLGoy9aD4b3nPXDoXNbSskrQ5hsBE", {
  contents: [
    {
      parts: [
        {
